...
//ACTIVE
    ...
    router.post('/admin/config',upload.single('myImage'), asyncHandler( async   function(req, res, next)
    {
        ...
        if (req.body.check_option === '0'){
            ...
            console.log(req.body.check_option);
        ...
        console.log(req.body.tenphim_edit);
        console.log(req.body.tenphim_edit);
        console.log(req.body.tenphim_edit);
        console.log(req.body.idphim_edit);
        console.log(req.body.idphim_edit);
        console.log(req.body.idphim_edit);
        console.log(req.body.thoiluong_edit);
        console.log(req.body.myImage);
        console.log(req.body.check_option);
    ...
    router.get('/admin/config/suatchieu',asyncHandler(async function(req, res, next)
    {
        ...
        res.render('auth/option/suatchieu', { layout: './layouts/sidebar',found_suatchieu,foundPhim,foundCumRap,foundRap,  found_AllMovie});
    }));
