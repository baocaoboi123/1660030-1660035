...
Phim.updatePhimByIDPhim = async function(IDphim, Tenphim, Posterphim, Thoiluong, check_option)
{
    if(check_option === '1'){ //khong thay doi posterphim
      return Phim.update({ Tenphim: Tenphim,  Thoiluong: Thoiluong}, {
        where: {
          IDphim: IDphim ,
        },
      });
    }else{ // thay doi posterphim
      return Phim.update({ Tenphim: Tenphim,  Thoiluong: Thoiluong,Posterphim: Posterphim  }, {
        where: {
          IDphim: IDphim ,
        },
      });
