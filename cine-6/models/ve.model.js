...
const Ve = db.define('Ve', {
  ...
  Ve.findAllVeByIDnguoidung= async function(NguoiDungAdminIDnguoidung)
    {
        return Ve.findAll({
            attributes: [
                'IDve','Maghe', 'Giatien'
            ...
            include: [{
                ...
                model: DatCho,
                attributes: [
                    'IDdatcho','Thoigiandatve', 'SuatChieuIDsuatchieu', 'NguoiDungAdminIDnguoidung'
                ],
                where: { 
                    NguoiDungAdminIDnguoidung,                
                 }
            }],
            group: ['IDdatcho','IDve'],
