...
const DatCho = db.define('DatCho', {
  ...
  DatCho.deleteDatChoByIDdatcho = async function(IDdatcho)
  {
      return DatCho.destroy({
          where: {
            IDdatcho: IDdatcho
          }
      });
  ...
  DatCho.findDatChoByIDsuatchieu = async function(SuatChieuIDsuatchieu)
  {
  ...
  DatCho.deleteDatChoByIDsuatchieu = async function(SuatChieuIDsuatchieu)
  {
      return DatCho.destroy({
          where: {
            SuatChieuIDsuatchieu: SuatChieuIDsuatchieu
