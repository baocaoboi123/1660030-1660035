...
const SuatChieu = db.define('SuatChieu', {
  ...
  SuatChieu.findSuatChieu = async function()
  {
  ...
  SuatChieu.findSuatChieuByID = async function(IDsuatchieu)
  {
    ...
    SuatChieu.findAllSuatChieuBy_Tphim_ddmmyyy = async function(Tenphim, start1_year)
    {
        // return users.find(u => u.email === email);
        return SuatChieu.findAll({
            attributes: [
    ...
    SuatChieu.findTenPhimChieuByIDsuatchieu = async function(IDsuatchieu)
    {
        // return users.find(u => u.email === email);
        return SuatChieu.findAll({
            attributes: [
    ...
    SuatChieu.updateSuatChieuIDsuatchieu = async function(IDsuatchieu, Giave, GioBatDau, GioKetThuc, Batdau )
    {
        
        
          return SuatChieu.update({ Giave: Giave,  GioBatDau: GioBatDau, GioKetThuc: GioKetThuc , Batdau: Batdau, Ketthuc: Batdau }, {
            where: {
                IDsuatchieu: IDsuatchieu ,
            },
          });
    ...
    SuatChieu.findAllSuatChieuByIdphimBDKT = async function(PhimIDphim, StartD, EndD)
    {
        return SuatChieu.findAll({
            where: {
                PhimIDphim: PhimIDphim,
    ...
    SuatChieu.findAllSuatChieuByIDrapBDKT = async function(RapIDrap, StartD, EndD)
    {
        return SuatChieu.findAll({
            where: {
                RapIDrap: RapIDrap,
            ...
            group: ['IDsuatchieu', 'RapIDrap']

            
        });
    };

    SuatChieu.dfg = async function( start1_year)
    {
        return SuatChieu.findAll({
            attributes: [
                'IDsuatchieu','RapIDrap', 'Batdau', 'Ketthuc','Giave', 'GioBatDau', 'GioKetThuc', 'PhimIDphim'
            ],
            where: {
