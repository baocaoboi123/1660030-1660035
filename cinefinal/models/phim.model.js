...
Phim.updatePhimByIDPhim = async function(Bio,Trailer,IDphim, Tenphim, Posterphim, Thoiluong, check_option, Ngaycongchieu)
{
    if(check_option === '1'){ //khong thay doi posterphim
      return Phim.update({Bio: Bio,Trailer:Trailer, Tenphim: Tenphim,  Thoiluong: Thoiluong, Ngaycongchieu: Ngaycongchieu}, {
        where: {
          IDphim: IDphim ,
        },
      });
    }else{ // thay doi posterphim
      return Phim.update({Bio:Bio,Trailer:Trailer, Tenphim: Tenphim,  Thoiluong: Thoiluong,Posterphim: Posterphim, Ngaycongchieu: Ngaycongchieu  }, {
        where: {
          IDphim: IDphim ,
        },
      });
...
Phim.createdPhim = async function(Bio, Trailer, Tenphim, Ngaycongchieu, Posterphim, Thoiluong)
{
