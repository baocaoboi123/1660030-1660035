...
//ACTIVE
        ...
        if (req.body.check_option === '0'){
            ...
            res.redirect('../../auth/admin/config');
                ...
                if(fileName === null)
                {
                    ...
                    const found_updatePhim =  Phim.updatePhimByIDPhim(req.body.idphim_edit, req.body.tenphim_edit, '', req.body.thoiluong_edit, '1', req.body.ngaycongchieu_edit);
                    const found_AllMovie =await Phim.find_All();
                    ...
                    const found_updatePhim =  Phim.updatePhimByIDPhim(req.body.idphim_edit, req.body.tenphim_edit, `/images/movie/${fileName}`, req.body.thoiluong_edit, '0', req.body.ngaycongchieu_edit);
                    const found_AllMovie =await Phim.find_All();
    ...
    router.get('/admin/profile',asyncHandler(async function(req, res, next)
    {
        ...
        console.log(found_Ve[0].DatCho.SuatChieuIDsuatchieu);
