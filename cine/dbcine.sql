        ...
        <div id="p" class="tab-pane fade in active show col-lg-12 col-md-12 col-12 w-50 pt-5 pb-5">
            <div class="card-deck mx-auto">
                <div class="img col-lg-3 col-md-3 col-12 w-50 pt-5 pb-5">
                          ...
                          <img style="  object-fit: cover;"  class="img-fluid container" src="<%- foundPhim.Posterphim%>" alt="">    
                ...
                <div class="text col-lg-9 col-md-9 col-12 w-50 pt-5 pb-5">
                    <div class="row">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                ...
                                <select class="custom-select"  name="selectedname" id="selectedname">
                                    <option value="">----Chọn Cụm Rạp----</option>
        
                                    <% for(const key in foundCumRap){
                                        if(tencumrap === foundCumRap[key].IDcumrap){%>
                                            <option selected value="<%- foundCumRap[key].IDcumrap%>"><%- foundCumRap[key].Tencumrap%></option>
                                ...
                                <% for(const key in foundCumRap){%>
                                    ...
                                    <select  class="data custom-select" name="<%- foundCumRap[key].IDcumrap%>" id="<%- foundCumRap[key].IDcumrap%>" >
                                            <%for(const temp in foundRap){
                                                if((foundCumRap[key].IDcumrap === foundRap[temp].CumRapIDcumrap) && (tenrap === foundRap[temp].Tenrap)){%>
                                                    
                                                        <option  selected  ><%-foundRap[temp].Tenrap%></option>
                                                <%}else if((foundCumRap[key].IDcumrap === foundRap[temp].CumRapIDcumrap) && (tenrap !== foundRap[temp].Tenrap)){%>
                    ...
                    <div class="row container d-flex">
                        <div class="nav nav-pills ml-auto p-1">
                                <form method="POST" >                                     
                                        ...
                                        <input hidden value="<%- foundPhim.IDphim%>"  type="text" name="tenphim" id="tenphim">                              
                    ...
                    <div class="row">
                        <div>
                            <!-------------------------->
                            <h1 type="text" id="tenphim">TÊN PHIM:  <%- foundPhim.Tenphim%></h1>
              
                            <h5 id="ngaycongchieu" >NGÀY CÔNG CHIẾU: </h5>

                            <div class="card-deck"> 

                                    <% for (const key in found_suatchieu){%>
                                          <div class="card " style=" max-width: auto; color: black;">
                                              <div class="card-body">
                                                  
                                                <h6 style="font-weight: bold;"   id="tempHHSS" class="card-title"><%-found_suatchieu[key].GioBatDau %></h5>
                                                
                                            
                                              </div>
                                              <div>
                                                  <a href="/muave/<%-found_suatchieu[key].IDsuatchieu%>">Mua ve</a>
